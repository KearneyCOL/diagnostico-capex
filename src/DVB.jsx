  ...
  { num:"01", key:"alineacion", icon:"🎯", label:"Alineación Estratégica",
    ...
    subs:[
      {id:"a1",t:"¿Las inversiones CAPEX están vinculadas explícitamente a objetivos estratégicos cuantificables (NPS, ARPU, cobertura, cuota de mercado)?",p:1.2,
       opp:"Crear una matriz CAPEX-KPI donde cada proyecto tenga al menos un indicador de negocio comprometido (ej. +X puntos NPS, +Y% cobertura 5G). Sin esto, el 40–60% del portafolio típicamente no tiene dueño de valor."},
      ...
      {id:"a3",t:"¿Se realiza revisión periódica (al menos anual) del alineamiento entre el plan estratégico y el presupuesto CAPEX aprobado?",p:1.0,
       opp:"Una revisión anual estructurada detecta proyectos que ya no responden a la estrategia vigente — en promedio el 15–20% del portafolio queda obsoleto entre ciclos sin este proceso."},
      ...
      {id:"a5",t:"¿Las brechas entre la estrategia y la capacidad de inversión son identificadas, cuantificadas y escaladas formalmente?",p:0.9,
       opp:"Cuantificar formalmente las brechas de inversión permite priorizar con evidencia: saber que faltan COP X para cumplir el objetivo de cobertura es diferente a intuirlo. Evita que proyectos críticos queden sin fondos por falta de visibilidad."},
      {id:"a6",t:"¿Las áreas de negocio y comerciales participan activamente en la definición y validación de los proyectos CAPEX?",p:0.8,
       opp:"En telcos, el 35–45% de proyectos CAPEX con mayor desviación son aquellos donde operaciones define la inversión sin input comercial. Incorporar a las áreas de negocio en el proceso reduce este riesgo y mejora la priorización."},
  ...
  { num:"02", key:"granularidad", icon:"🔬", label:"Granularidad y Desagregación",
    ...
    subs:[
      ...
      {id:"g4",t:"¿El nivel de granularidad permite identificar inversión por región geográfica, segmento de cliente o unidad de negocio?",p:1.0,
       opp:"Sin granularidad geográfica no se puede responder: ¿dónde genera más valor cada COP invertido? Esta vista permite optimizar el portafolio redirigiendo inversión a regiones con mayor potencial de ARPU o cobertura competitiva."},
  ...
  { num:"03", key:"aprobacion", icon:"✅", label:"Proceso de Aprobación de CAPEX",
    ...
    subs:[
      {id:"ap1",t:"¿Existe un proceso formal para identificar, registrar y evaluar proyectos candidatos al presupuesto CAPEX?",p:1.2,
       opp:"Sin proceso formal, los proyectos entran al presupuesto por influencia política o urgencia operativa, no por valor. Formalizar el pipeline asegura que cada COP compita bajo los mismos criterios y el portafolio sea defendible ante el board."},
      {id:"ap2",t:"¿Se elabora un business case estándar para cada proyecto antes de su inclusión, con ROI, payback y análisis de riesgo?",p:1.2,
       opp:"El business case estándar con ROI y payback es el filtro más eficiente contra proyectos de bajo valor. Telcos con este proceso reportan portafolios con 25–35% mayor retorno esperado vs. las que aprueban proyectos sin este requisito."},
      {id:"ap3",t:"¿Los proyectos son priorizados mediante scoring multicriteria (ROI, impacto estratégico, riesgo técnico, regulatorio)?",p:1.1,
       opp:"El scoring multicriteria elimina el sesgo del área que pide el presupuesto. Un proyecto de IT con ROI de 3x puede ser menos prioritario que uno de red con ROI de 1.5x si el impacto estratégico y regulatorio es mayor — solo el scoring lo revela."},
      ...
      {id:"ap7",t:"¿Se realizan revisiones post-inversión (PIR) para validar que los proyectos aprobados entregaron el valor comprometido?",p:0.8,
       opp:"Las PIR revelan el gap entre el valor prometido y el entregado. En telcos, los proyectos de infraestructura pasiva típicamente entregan 60–80% del ARPU comprometido. Sin PIR, este patrón se repite ciclo a ciclo sin corrección."},
    ]},
  ...
  { num:"05", key:"riesgos", icon:"⚠", label:"Gestión de Riesgos",
    ...
    subs:[
      ...
      {id:"r6",t:"¿El proceso incorpora lecciones aprendidas de proyectos anteriores para mejorar la gestión de riesgos actuales?",p:0.8,
       opp:"Las lecciones aprendidas de proyectos anteriores son el activo más subvalorado en planeación CAPEX. Saber que los proyectos de migración HFC tienen un 35% de sobrecosto histórico cambia radicalmente el business case del siguiente ciclo."},
